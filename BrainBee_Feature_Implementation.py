...
def countdown():
    ...
    greetinglist = ["/// BB ///", "/// Meditation ///", "/// WillCatonJr ///", "/// Brain Bee ///", "/// Love is the Proximate Cause ///"]
...
inhale = ttk.Scale(root,from_=0, to=20, orient=HORIZONTAL)
inhale.place(x=150,y=250)

hold = ttk.Scale(root,
from_=0, to=20, orient=HORIZONTAL)
hold.place(x=150,y=280)

exhale = ttk.Scale(root,
from_=0, to=20, orient=HORIZONTAL)
exhale.place(x=150,y=310)

enter_btn = customtkinter.CTkButton(root, text="START", command=countdown, text_color="#45a247",
width=button_width, height=button_height, fg_color="#0f9b0f")
enter_btn.place(x=150,y=250)

exit_quit = customtkinter.CTkButton(root, text="EXIT", command=exit, text_color="#FF0000",
width=button_width, height=button_height, fg_color="#0f9b0f")
exit_quit.place(x=150,y=280)

reset_btn = customtkinter.CTkButton(root, text="RESET", command=reset, text_color="#FFF200",
width=button_width, height=button_height, fg_color="#0f9b0f")
reset_btn.place(x=150,y=300)
